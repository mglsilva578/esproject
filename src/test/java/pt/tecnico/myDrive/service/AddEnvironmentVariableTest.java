...
public class AddEnvironmentVariableTest extends AbstractServiceTest{
	...
	private void addInitialEnvironmentVariablesToUser1() {
		...
		this.addEnvironmentVariableToUser1(user1Session, existingUser1FirstVariableName, existingUser1FirstVariableValue);
		this.addEnvironmentVariableToUser1(user1Session, existingUser1SecondVariableName, existingUser1SecondVariableValue);
	}
	...
	private List<EnvironmentVariableDto> whenAddFirstEnvironmentVariable(Long token) {
	...
	private void whenTryToAddEnvironmentVariableWithNullName() {
		AddEnvironmentVariableService service = new AddEnvironmentVariableService(null, firstNewEnvironmentVariableName, firstNewEnvironmentVariableValue);
		service.execute();
	}
